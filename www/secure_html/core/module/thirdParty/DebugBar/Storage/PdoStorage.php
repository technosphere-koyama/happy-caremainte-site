...
class PdoStorage implements StorageInterface
{
    ...
    protected $sqlQueries = array(
        'save' => "INSERT INTO %tablename% (data, meta_utime, meta_datetime, meta_uri, meta_ip, meta_method) VALUES (?, ?, ?, ?, ?, ?)",
     ...
     */
    public function __construct(PDO $pdo, $tableName = 'debug_bar_data', array $sqlQueries = array())
    {
        $this->pdo = $pdo;
    ...
    public function save($id, $data)
    {
        ...
        $meta = $data['__meta'];
        $stmt->execute(array(serialize($data), $meta['utime'], $meta['datetime'], $meta['uri'], $meta['ip'], $meta['method']));
    }
