...
class Swift_Mime_Headers_MailboxHeader extends Swift_Mime_Headers_AbstractHeader
{
    ...
    private function _assertValidAddress($address)
    {
		...
		/*
		 * 20151015 hesaka
		 * メールの形式が正しくない場合はここでFatalErrorを吐く
		 * でも実際存在してちゃんと動作するメールアドレスでもエラーになる
		 * ここはnoticeログを吐くだけにして、エラースローはしないでおく
		 * 参考サイト：http://rys.hatenablog.com/entry/2012/06/07/185016
		 */
		LOGS_NOTICE('mailaddress does not comply with RFC 2822, 3.6.2. [' . $address . ']');
/*
