		...
		<div class="content">
			...
			<div class="sale">
				<div class="sale_header">
					<h2>メルマガ／マイページ会員のみなさまだけに、<br class="PCpart">特別なご優待チケット！</h2>
					<p>いつもハッピー ケアメンテ&reg;をご利用いただきありがとうございます。<br class="PCpart">
					<a href="/mypageuse/use_mypage/" target="_blank"><u>メルマガ／マイページ会員</u></a>の皆さまだけがご利用いただだける特別なご優待チケットをご用意させていただきました。<br class="PCpart">
					以下の「お申込み注文」ボタンからケアメンテ&reg;をご注文いただくと割引サービスをお受けいただけます。<br class="PCpart">
			...
			<div class="sale">
				<div class="sale_header">
					<h2>マイページ会員に登録していただくと<br class="PCpart">会員様限定のお得なご優待チケットをご利用いただけます。</h2>
					...
					<div class="memberbtnarea">
						<div class="line">
							...
							<div class="btn"><a href="/entry/">マイページ会員に登録</a></div>
							<div class="btn login"><a href="/login/?callback=/salemail/">登録済みの方はこちら（ログイン）</a></div>
						</div>
					</div>
				</div>
			</div>
