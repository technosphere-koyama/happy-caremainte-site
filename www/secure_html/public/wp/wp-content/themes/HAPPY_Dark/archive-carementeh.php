<?php get_header(); ?>
  ...
  <div class="content">
      ...
      <div class="pagettl-lead">
        <h4>“きれい”の先にある新習慣・ケアメンテ&reg;</h4>
        <h3>あなたの服とシッカリ向き合って、<br class="SPpart">新品と同じほどに<br>ケアメンテ&reg;は、最上級の美しさをお届けします。</h3>
      </div>
      <div class="tac movieBtn"><a href="#movie"><img src="/_assets/img/carementeh/btn1.png" srcset="/_assets/img/carementeh/btn1.png 2x" alt="MOVIE"></a></div>
      ...
      <div id="movie">
          <div class="promo">
              <a href="https://www.youtube.com/watch?v=4okBMUdZc_E?rel=0" target="_blank"><img src="/_assets/img_sp/movie/thumb_img02.jpg" alt="MOVIE"></a>
          </div>
      </div>
