...
<small>高級クリーニングの先をゆくハッピーケアメンテ&reg;</p></small>
	...
	<?php endforeach; ?>
		...
		<div class="container" id="pc_below_banner">
			<div class="pc_saiful_banner">
				<a href="https://www.happy-saiful.com/Views/index.html" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pc_happy-saiful_banner.png" alt="" /></a>
			</div>
			<div class="pc_saiful_banner">
				<a href="https://www.happy-saiful.com/Views/index.html" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/pc_happy-saiful_banner.jpg" alt="" /></a>
			</div>
		</div>

		<div class="container" id="mobile_below_banner">
			<div class="mobile_saiful_banner">
				<a href="https://www.happy-saiful.com/Views/index.html" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mobile_happy-saiful_banner.png" alt="" /></a>
			</div>
			<div class="mobile_saiful_banner">
				<a href="https://www.happy-saiful.com/Views/index.html" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/mobile_happy-saiful_banner.jpg" alt="" /></a>
			</div>
	...
	<div class="new-top-concept">
		...
		国連貿易開発会議(UNCTAD)は、ファッション業界を<br class="con-br">世界第２位の環境汚染産業として指摘しており、<br />
		日本では年間51万トンもの衣料品が廃棄されています<br class="con-br">（環境省広報）。<br /><br />
		そこで、私たちハッピーケアメンテ&reg;は、<br class="con-br">ファッション業界の環境汚染を解決するために、<br />
		年間わずか４～５万点ですが、<br class="con-br">「ケアメンテ技術」によって、捨てられる運命の服飾品を<br />
		着続けられるように、持ち続けられるように<br class="con-br">「再生産」のビジネスモデルを提供しています。<br /><br />
	...
	<div class="order-useL">
		<div class="order-use-mail"><a href="/order/form.html"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/top-truck.png" alt="お問い合わせ">WEBからのご注文はこちら　＞</a></div>
	</div>
	...
	<br clear="all">
	<div class="container" id="hermes-top">
		<div class="btnArea">
			<div class="hermes">
				<a href="tel:0120-88-3040">
				<span class="hermes-L">エルメス お客様専用ダイヤル</span><br class="sp"><span class="hermes-R">0120-88-3040</span></a>
			</div>
		</div>
	</div>
