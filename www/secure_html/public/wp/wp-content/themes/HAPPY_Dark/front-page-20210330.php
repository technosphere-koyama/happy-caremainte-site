...
<?php if ( is_front_page() ) : ?>
	<div id="left_banner">
		<div id="left_banner_inner">
			...
			<a href="https://www.kyoto-happy.co.jp/carementeh_search/form.html"><img src="https://www.kyoto-happy.co.jp/wp/wp-content/themes/HAPPY_Dark/item/care_maintenance.png" alt=""></a>
		</div>
...
<div class="bg">
	...
	<section id="technology">
		<div class="container">
			...
			<div class="technology_under">
				<a href="/carementeh/overview/difference/">クリーニングとケアメンテ&reg;はどこが違うの？ ＞</a>
			</div>
			<div class="technology_pv">
				<h3 class="tac">動画で見るアイテム別 <br class="sp">驚異のケアメンテ&reg;</h3>
				<ul class="slick_technology_list">
					<li><a href="https://www.youtube.com/embed/pOZPaiVtIVE" class="popup cboxElement" target="_blank">
						<p class="number">00</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv00.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv00.png" alt="" class="font" width="275" height="113"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">完結編</h4></a>
					</li>
					<li><a href="https://www.youtube.com/embed/yzTc75yHZ0M" class="popup cboxElement" target="_blank">
						<p class="number">01</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv01.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv01.png" alt="" class="font" width="98" height="50"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">ダウン類</h4></a>
					</li>
					<li><a href="https://www.youtube.com/embed/A7kSrLF3mdg" class="popup cboxElement" target="_blank">
						<p class="number">02</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv02.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv02.png" alt="" class="font" width="178" height="57"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">レザーグレイン</h4></a>
					</li>
					<li><a href="https://www.youtube.com/embed/ZF5HM76OxZw" class="popup cboxElement" target="_blank">
						<p class="number">03</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv03.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv03.png" alt="" class="font" width="140" height="55"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">メンズスーツ</h4></a>
					</li>
					<li><a href="https://www.youtube.com/embed/IgkwDl84V9g" class="popup cboxElement" target="_blank">
						<p class="number">04</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv04.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv04.png" alt="" class="font" width="140" height="55"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">レディースシルク</h4></a>
					</li>
					<li><a href="https://www.youtube.com/embed/Cv9idLb6GFw" class="popup cboxElement" target="_blank">
						<p class="number">05</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv05.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv05.png" alt="" class="font" width="140" height="55"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">シルエット・ディティール</h4></a>
					</li>
					<li><a href="https://www.youtube.com/embed/6b8L-JpDj2s" class="popup cboxElement" target="_blank">
						<p class="number">06</p>
						<div class="img"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv06.jpg" alt="" class="thum"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv06.png" alt="" class="font" width="140" height="55"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/technology_pv_play.png" alt="" class="play" width="71" height="71"></div>
						<h4 class="tac">ゴム引き（マッキントッシュ）</h4></a>
					</li>
				</ul>
				<div class="btnArea">
					<div class="btn"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/youtube.png" alt="youtube" class="youtube_logo" width="90" height="21"><br class="sp">
						<a href="https://www.youtube.com/channel/UCZyJC69VvnDqIAgsEQ-rTeQ">チャンネル登録はこちら</a>
					</div>
					<div class="btn">
	...
	<section id="service">
		<div class="container">
			...
			<ul class="service_list">
				<li>
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service01.jpg" alt="全業務を一元管理する「電子カルテ」">
					<h4><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service_tit01.png" alt="全業務を一元管理する「電子カルテ」" width="65" height="285"></h4>
					<a href="/carementeh/overview/karte/">ハッピー電子カルテシステム</a>
				</li>
				<li>
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service02.jpg" alt="服は息をしている保管お預かりサービス">
					<h4><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service_tit02.png" alt="服は息をしている保管お預かりサービス" width="65" height="284"></h4>
					<a href="/carementeh/service/wardrobe/">ハッピーワードローブ&reg;</a>
				</li>
				<li>
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service03.jpg" alt="クリーニングの限界を超える">
					<h4><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service_tit03.png" alt="クリーニングの限界を超える" width="65" height="198"></h4>
					<a href="/carementeh/overview/style/">ケアメンテ 仕事スタイル</a>
				</li>
				<li>
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service04.jpg" alt="入荷から出荷まで大切なお洋服を丁寧に">
					<h4><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service_tit04.png" alt="入荷から出荷まで大切なお洋服を丁寧に" width="65" height="285"></h4>
					<a href="/carementeh/overview/flow/">ケアメンテ 仕事の流れ</a>
				</li>
			</ul>
			<div class="banner">
				<a href="/corporate/csr/reuse/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/service_bnr.jpg" alt="自然循環型産業の創出">
	...
	<section id="service">
		<div class="container">
			...
			<div class="tac link">
				<a href="/carementeh/overview/difference/">クリーニングとケアメンテ&#174; はどこが違うの? ></a>
			</div>
		</div>
	</section>
	...
	<section id="case">
		<div class="container">
			...
			<h2 class="tac"><span>Before & After 検索<span class="pc"> / </span><br class="sp">概算お見積り事例集</span><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/header01_w_or.png" alt="">「さがす」</h2>
			<p class="tit_txt">あなたのご依頼品の概算見積りが確認できます。<br class="pc">
			2,000点を超えるBefore & After事例集から検索して仕上がり感をイメージできます。</p>
			<ul class="slick_case_list">
				<li>
					<a href="/carementeh_search/detail.html?item_id=0001981">
					<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/search/index/0001981.jpg" alt="case01">
				...
				<li>
					<a href="/carementeh_search/detail.html?item_id=0002120">
					<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/search/index/0002120.jpg" alt="case02">
					<div class="case_list_txt">
						<h3>ESCADA<span>婦人上着</span></h3>
						<p>綿98%  ｳﾚﾀﾝ2%<br><br>オフ白</p>
					</div>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="/carementeh_search/detail.html?item_id=0003238">
					<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/search/index/0003238.jpg" alt="case01">
					<div class="case_list_txt">
						<h3>CELINE<span>長袖ブラウス</span></h3>
						<p>ｼﾙｸ100%<br><br>オフ白</p>
					</div>
				</a>
				</li>
				<li>
				...
				<li>
					<a href="/carementeh_search/detail.html?item_id=0003977">
					<img src="/external_image.html?url=http://kh01.kyoto-happy.co.jp/netkuroku/images/N00039777.jpg" alt="case01">
					<div class="case_list_txt">
						<h3>GIORGIO BRA…<span>スエードジャケット</span></h3>
						<p>羊革<br><br>茶系</p>
					</div>
				</a>
				</li>
			...
			<div class="btn">
				<a href="/carementeh_search/">事例集をもっと見る</a>
			</div>
		</div>
	</section>
	<!--　/#case -->
	...
	<section id="use">
		<div class="container">
			...
			<p class="tit_txt">クリーニングの悩みや困りごとをハッピーケアメンテが解消します。
				お客様のご都合に合わせた豊富なご注文方法とメニューであなたの大事な衣服をお預かりします。</p>
			<div class="promo">
				<a href="https://www.youtube.com/watch?v=UND_m_Aho44?rel=0" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/use_thumb.jpg" alt="MOVIE"></a>
			</div>
			<div class="btnArea">
				<div class="banner">
	...
	<section id="partner">
		<div class="container">
			<h2 class="tac">提携ブランド<span class="pc">／</span><br class="sp">全国取扱い店舗一覧</h2>
		<p>様々なファッションブランドやショップ・企業がケアメンテ&reg;と提携。<br>ケアメンテ&reg;を推奨する全国のブランドやデパートでご依頼品のお預かりを受け付けております。</p>
			<ul class="tac">
				<li><a href="/shop/brand/tomorrowland/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_01.gif" alt="TOMORROWLAND"></a>
				</li>
				<li><a href="/shop/brand/beams/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_02.gif" alt="BEAMS"></a>
				</li>
				<li><a href="/shop/brand/united-arrows/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_03.gif" alt="UNITED ARROWS"></a>
				</li>
				<li><a href="/shop/brand/aquascutum/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_04.gif" alt="Aquascutum"></a>
				</li>
				<li><a href="/shop/brand/durban/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_05.gif" alt="DURBAN"></a>
				</li>
				<li><a href="/shop/brand/sinjuku_takashimaya/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_06.gif" alt="新宿タカシマヤ"></a>
				</li>
				<li><a href="/shop/brand/seibu_ikebukuro/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_07.gif" alt="西武池袋本店"></a>
				</li>
				<li><a href="/shop/brand/abeno_harukas/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_08.gif" alt="あべのハルカス 近鉄本店"></a>
				</li>
				<li><a href="/shop/brand/yokohama_takashimaya/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_09.gif" alt="横浜タカシマヤ"></a>
				</li>
				<li><a href="/shop/brand/komehyo/">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/partner_logo_10.gif" alt="KOMEHYO"></a>
				</li>
			</ul>
			<div class="btnArea">
				<div class="hermes">
					<a href="tel:0120-88-3040">
					<span>エルメス公認 お客様専用ダイヤル</span><br class="sp"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon_tel_w.png" alt="tel">0120-88-3040</a>
				</div>
				<div class="btn tac">
					<a href="/shop_search/">近くの店舗をさがす</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="banner">
				<a href="/sachi/">
					...
					<div class="banner_txt">
						<!--h2>京の伝統工芸職人を追う<span class="small">Vol. 25<br class="pc">中村藤 本店</span>
							<br>Webマガジン 「幸」 -sachi-</h2-->
