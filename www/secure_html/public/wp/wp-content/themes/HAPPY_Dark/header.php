...
if(is_front_page()): ?>
	...
	<link rel="stylesheet" href="https://www.kyoto-happy.co.jp/_assets/css/top_lp.css">
<?php /*追加*/ ?>
...
<?php endif; ?>
		...
		<div class="wrap">
			<div class="title">
				<ul>
					<li><a href="<?php echo home_url(); ?>"><div><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/logo_w.png" alt="ハッピー ケアメンテ" class="logo"></div></a></li>
