<?php get_header() ?>
	...
	<div id="Contents">
		...
		<div id="container">
			<div id="theTargetSP">
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv01_sp_ver4.jpg?190523)"><a href="/carementeh/">ハッピー「ケアメンテ」で幸福をつくろう</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv08_sp.jpg?190523)"><a href="sachi/#Shortcut" target="_blank">有栖川宮家と京都・圓福寺のゆかりを温ねて</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv09_sp_ver4.jpg?190523)"><a href="/mariopecora/">19世紀イタリア王家「サボイア家」の専属仕立師「マリオ・ペコラ」が絶賛</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv06_sp_ver4.jpg?190523)"><a href="/carementeh_search/">ケアメンテ事例集 さがす</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv04_sp_ver4.jpg?190523)"><a href="/shop/">提携ブランド・取扱い店舗一覧</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv07_sp_ver2.jpg?190523)"><a href="https://www.kyoto-happy.co.jp:8443/pdf/Manga.pdf?ver1.1" target="_blank">もっと服が輝く</a></div>
			</div>
			<div id="theTarget">
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv01_ver4.jpg?190523)"><a href="/carementeh/">ハッピー「ケアメンテ」で幸福をつくろう</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv08.jpg?190523)"><a href="sachi/#Shortcut" target="_blank">有栖川宮家と京都・圓福寺のゆかりを温ねて</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv09_ver4.jpg?190523)"><a href="/mariopecora/">19世紀イタリア王家「サボイア家」の専属仕立師「マリオ・ペコラ」が絶賛</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv06_ver4.jpg?190523)"><a href="/carementeh_search/">ケアメンテ事例集 さがす</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv04_ver4.jpg?190523)"><a href="/shop/">提携ブランド・取扱い店舗一覧</a></div>
				<div style="background-image: url(https://www.kyoto-happy.co.jp:8443/_assets/img/index/pct_newkv07_ver2.jpg?190523)"><a href="https://www.kyoto-happy.co.jp:8443/pdf/Manga.pdf?ver1.1" target="_blank">もっと服が輝く</a></div>
			</div>
		</div>
	...
	<div class="bgGray">
		...
		<div class="unicef_headline">
			<a href="/corporate/csr/unicef/">■「ハッピーワールド助け合いプロジェクト」の<br />履歴はコチラ→</a>
		</div>
		...
		<section class="seotext__section">
			<div class="wrap">
				<h2>高級クリーニング VS ハッピーケアメンテの検証</h2>
					<div class="SeoContents">
						<div class="SeoBox">
							<p class="txt">ハッピーケアメンテは、高級クリーニングで“シミ・汚れ・黄ばみ・ニオイが取れない、色が変わった（変色・色むら）、シミが浮き出てきた”など、クリーニングの悩みや困りごとを解消します。特に、高級で上質なラグジュアリーブランドの衣服、エルメスのバッグやシャネルのスーツなど、ケアメンテで奇麗（キレイ）に美しく新品のように蘇らせることができます。<span class="PCpart">また、シーズンオフのお預かり保管、その他、はっ水・UVカット・抗菌などの加工や修理・修繕のご要望にもお応えしております。ハッピーは、世界の高級ラグジュアリーブランドから信頼を得て、全国のお客様にケアメンテを提供している京都に本社を置く企業です。クリーニングをお分かりいただくには「もっと服が輝く（漫画）」をご覧ください。ハッピーケアメンテを「なっとく」していただけます。</span><br />
							<div class="linkbtn　PCpart">
								<a href="https://www.kyoto-happy.co.jp:8443/pdf/Manga.pdf?ver1.1" target="_blank"><div class="btn PCpart">マンガで｢ヒモ解く｣クリーニング VS ケアメンテ<br />マンガを読む<i class="fa fa-angle-right" aria-hidden="true"></i></div></a>
							</div>
						</div>
						</p>
						<p class="manga" /><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/Manga.jpg" alt="マンガで｢ヒモ解く｣クリーニング VS ケアメンテマンガを読む"></p>
					</div>
				<div class="linkbtn SPpart">
					<a href="https://www.kyoto-happy.co.jp:8443/pdf/Manga.pdf?ver1.1" target="_blank"><div class="btn">マンガで｢ヒモ解く｣クリーニング VS ケアメンテ<br />マンガを読む<i class="fa fa-angle-right" aria-hidden="true"></i></div></a>
				</div>
			</div>
		</section>
		...
		<section class="link_3rd__section">
			<div class="wrap">
				<ul class="menu2">
					<li>
						<a href="/knowledge/">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd-1.jpg" alt="おしゃれの雑学">
						</a>
					</li>
					<li>
						<a href="/movie/">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd-2.jpg" alt="プロモーションビデオ">
						</a>
					</li>
					<li>
						<a href="/shop/">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd-3.jpg" alt="おしゃれの雑学">
						</a>
					</li>
					<li>
		...
		<section class="link_2nd__section">
			<div class="wrap">
				<ul>
					<li><a href="/detail/"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/lp/topic_04.jpg" alt="こだわりのシルエット・ディテールを演出するケアメンテ おしゃれの裏づけ ハッピーが選んだハイグレードアイテムをご紹介。"></a></li>
					<li><a href="#inline-content3" class="popup"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/lp/topic_05.jpg" alt="ぞくぞくと寄せられる「きれい」の声 ケアメンテ体験者の声 ご注文・お問合わせはお気軽にお電話ください 0120-88-6868"></a></li>
				</ul>
			</div>
		</section>

		<section class="manga__section">
			<div class="pct"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/mangabtn_pc.jpg" alt="もっと服が輝く" class="PCpart"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/mangabtn_sp.jpg" alt="もっと服が輝く" class="SPpart"></div>
			<div class="linkbtn">
				<div><a href="https://www.kyoto-happy.co.jp:8443/pdf/Manga.pdf?ver1.1" target="_blank"><div class="btn">「クリーニングの不思議」の<br class="SPpart" />マンガを読む<i class="fa fa-angle-right" aria-hidden="true"></i></div></a></div>
			</div>
		</section>
		...
		<section class="sachi__section">
			<div class="wrap">
				...
				<div class="pct"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/sachi_img190220.jpg" alt="有栖川宮家と京都・圓福寺のゆかりを温ねて"></div>
				<div class="contents">
					...
					<a href="sachi/#backnumber"><u>旧版（冊子版）のバックナンバーはPDFでご覧いただけます。</u></a></div>
				</div>
			</div>
		...
		<section class="link_3rd__section">
			<div class="wrap">
				<ul class="menu1">
					<li>
						<a href="/carementeh_search/">
							<h2><span>Before & After実例集</span>さがす</h2>
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/ico_search.svg" alt="さがす">
							<p>Before & After実例集から検索して<br class="PCpart">仕上がり感をイメージできます。</p>
						</a>
					</li>
					<li>
						<a href="/review/">
				...
				<div class="happySNS">
					<div class="topWrap">
						<div class="left">
							<h2><span>ハッピーSNS『つなぐ』</span><br />コミュニケーション広場</h2>
							<p>“ハッピーSNS『つなぐ』”では、アカウントをお持ちの方々の情報交換の他、「ハッピー」のオフィシャルメッセンジャーが発信する“ここで”しか得られない貴重な情報を、どなたでもご覧いただくことができます。<br>
							（※コメントの書き込み機能などのご利用はアカウント登録が必要です。ぜひ、アカウント登録のうえご参加ください。お待ちしております。）</p>
...
?>
		...
		<section class="apps__section">
			<a href="/use/howtoorder/apps/">
				<div class="wrap">
					<div class="pctPC"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/apps_pct-pc.jpg" alt="" class=""></div>
					<div class="pctSP"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/apps_pct-sp.jpg" alt="" class=""></div>
					<div class="title"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/apps_title.jpg" alt="" class="ケアメンテアプリ"></div>
					<div class="icon"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/apps_icon.jpg" alt="" class="iOS android"></div>
					<div class="mark"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/apps_mark.jpg" alt="" class="無料"></div>
					<div class="txt">ケアメンテアプリは、ケアメンテ事例集「さがす」や、ご依頼品のご注文、マイページでケアメンテご依頼品のご利用履歴の確認や電子カルテの閲覧など、お手持ち衣類の管理ツールとしてもご活用いただける便利なアプリです。</div>
					<div class="bottomWrap">
						<div class="linkbtn">
							<div class="btn">詳しくはこちら<i class="fa fa-angle-right" aria-hidden="true"></i></div>
						</div>
					</div>
				</div>
			</a>
