		...
		<div id="Contents">
				...
				<ul>
					...
					<li class="btn-area">
						<ul id="control">
							...
							<li><a href="#technology_pv6" class="popup"><img src="https://www.kyoto-happy.co.jp:8443/_assets/movie/technology_pv6.jpg" alt="">シルエット・ディティール<br /><span class="time">0:29</span></a></li>
			...
			<section class="banner_section">
				<ul>
					...
					<li><a href="/detail/"><div class="banner_bg"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index2019/banner_img_03.jpg" alt="こだわりのディティール"></div><h3><span>ハッピーが厳選した事例をご紹介</span>こだわりのディティール</h3></a></li>
