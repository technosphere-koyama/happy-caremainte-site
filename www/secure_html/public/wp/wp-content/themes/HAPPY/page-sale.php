		...
		<div class="content">
			...
			<div class="sale">
				<div class="sale_header">
					<h2>マイページ会員のお客様だけに、さらにお得なご優待チケット！</h2>
					<p>いつもハッピー ケアメンテ&reg;をご利用いただきありがとうございます。<br class="PCpart">
					<a href="/mypageuse/use_mypage/" target="_blank"><u>マイページ会員</u></a>のお客様にご利用いただだけるご優待チケットをご用意させていただきました。<br class="PCpart">
					以下の「お申込み注文」ボタン、あるいはお電話で優待コードをお伝えいただいてケアメンテ&reg;をご注文いただくと<br class="PCpart">
					割引サービスをお受けいただけます。<br class="PCpart">
