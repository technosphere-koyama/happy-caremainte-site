		...
		<section class="link_3rd__section">
			<div class="wrap">
				<ul class="menu2">
					<li>
						<a href="/knowledge/">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd_01.jpg" alt="おしゃれの雑学">
							<p>オシャレを楽しむ情報満載</p>
							<h2>おしゃれの雑学</h2>
						</a>
					</li>
					<li>
						<a href="/movie/">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd_02.jpg" alt="プロモーションビデオ">
							<p>ケアメンテの仕事スタイルを動画でご紹介</p>
							<h2>プロモーションビデオ</h2>							
						</a>
					</li>
					<li>
						<a href="/shop/">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd_03.jpg" alt="おしゃれの雑学">
							<p>全国のケアメンテ取扱い店舗で受付可能</p>
							<h2>提携ブランド・取り扱い店舗一覧</h2>							
						</a>
					</li>
					<li>
						<a href="#inline-content2" class="popup cboxElement">
							<img src="https://www.kyoto-happy.co.jp:8443/_assets/img/index/link_3rd_04.svg" alt="類似サービスにご注意">
							<h2>類似サービスにご注意</h2>
							<p> 「ケアメンテ」はハッピーの登録商標です。クリーニングやネット宅配クリーニングではありません。</p>
						</a>
					</li>
					<li>
						<a href="/corporate/media/past/">
							<h2>報道一覧</h2>
							<p> これまでにメディアで紹介された情報を掲載しています。</p>
						</a>
					</li>
				</ul>
			</div>
