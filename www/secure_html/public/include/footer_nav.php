			...
			<div class="gFooter">
				<ul>
					<li><a href="/"><div class="gFooterImg">
						<?php if ($this->get("page_group") == "index") {?>
							<img src="/wp/wp-content/themes/HAPPY_Dark/img/icon_s_home_a.png" alt="HOME"></div>
							<span class="act">ホーム</span>
						<?php } else {?>
					...
					<?php if ($this->get("page_group") == "search") {?>
					...
					<li><a href="/mypage/sns.html"><div class="gFooterImg">
						<?php if ($this->get("page_group") == "community") {?>
							<img src="/wp/wp-content/themes/HAPPY_Dark/img/icon_s_global_a.png" alt="つなぐ"></div>
							<span class="act">つなぐ</span>
						<?php } else {?>
					...
					<li><a href="/mypage/"><div class="gFooterImg">
						<?php if ($this->get("page_group") == "mypage") {?>
							<img src="/wp/wp-content/themes/HAPPY_Dark/img/icon_s_user_a.png" alt="マイページ"></div>
							<span class="act">マイページ</span>
						<?php } else {?>
					...
					<li><a href="/order/"><div class="gFooterImg">
						<?php if ($this->get("page_group") == "order") {?>
