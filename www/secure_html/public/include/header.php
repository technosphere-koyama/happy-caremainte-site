...
<header id="header">
			...
			<div class="wrap">
				<div class="title">
					<h1 class="logo"><a href="/"><picture><source srcset="https://www.kyoto-happy.co.jp:8443/_assets/img/header/logo_sp.gif" media="(max-width:767px)"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/header/logo.gif" alt="ハッピー ケアメンテ"></picture></a></h1>
				</div>
				<div class="sublink PCpart">
					<ul>
						...
						<li class="tel">
							<div class="tel_top"><a href="#telPopup" class="popup"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/header2019/tel.gif" alt="ハッピーはお客さまとの会話を大切にしています 0120-88-6868 月～土 9:00～18:00（日曜・祝祭日は除く）"></a></div>
							<div class="tel_bottom"><a href="tel:0120-88-3040"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img/header2019/tel_hermes.gif" alt="エルメス公認 お客様ご愛用ダイヤル 0120-88-3040"></a></div>
						</li>
				...
				<div class="wrapSP">
					...
					<div class="mainmenu">
						...
						<div class="menu">
							<div class="menu_triggerBtn"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img_sp/header/icon_menu.png" width="26" height="28" alt="MENU"></div>
							<div class="menu_closeBtn"><img src="https://www.kyoto-happy.co.jp:8443/_assets/img_sp/menu/btn_close.png" width="26" height="29" alt="CLOSE"></div>
						</div>
						<span class="menu_bg"></span>
						<div class="menu_over">
							<div id="SPGnavi">
								<div class="menu1">
									<div class="SPGnavi_menu">ご利用方法/価格表</div>
									<ul>
										<li><h3>ご利用方法</h3></li>
									...
									<div class="SPGnavi_menu">ケアメンテを支える技術</div>
									<ul>
									...
									<ul>
										...
										<li><a href="/shop/brand/komehyo/">KOMEHYO</a></li>
									</ul>
			...
			<div style="display:none;" class="news_headline-detail">
				<section id="telPopup" class="cbox_popup">
					<h3>休業日（日曜・祝祭日）中の電話対応について</h3>
					<p>音声ガイダンスにしたがってお名前・お電話番号・ご用件を録音してください。<br>翌営業日に折返しご連絡させていただきます。<br><br>ホームページからのご注文（ご依頼品お引取りのお申込み）につきましては、<br class="PCpart">24時間受付けております。<br>当社休業日に関わらず、日曜・祝祭日もご依頼品のお引取りに伺うことができますので、<br class="PCpart">ぜひご利用ください。<br><br>ホームページからの<a href="/order/">ご注文はコチラ</a></p>
				</section>
			</div>
		</header>
